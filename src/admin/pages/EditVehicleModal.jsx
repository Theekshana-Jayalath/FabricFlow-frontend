...
const EditVehicleModal = ({ vehicle, onClose, onVehicleUpdated }) => {
  ...
  // Initialize form data with vehicle data
  useEffect(() => {
    if (vehicle) {
      setFormData({
        ...
        assignedDriverId: vehicle.assignedDriverId?._id || ''
      });
    }
  }, [vehicle]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`https://fabricflow-backend1.onrender.com/api/vehicles/${vehicle._id}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Update vehicle details for {vehicle.registrationNumber}</p>
            </div>
          </div>
          <button
            onClick={onClose}
            ...
            <div className="md:col-span-2">
              ...
              {vehicle.assignedDriverId && (
                <p className="mt-1 text-sm text-gray-500">
                  Currently assigned to: {vehicle.assignedDriverId.name}
                </p>
              )}
            </div>
          </div>
